    ...
    <div className="page-main-container">
      ...
      <div className={`page-inner-container ${isCollapsed ? 'collapsed' : 'expanded'}`}>
        ...
        <div className="page-content">
          <section className="busi-page">
            <div className="busi-page-header">
  ...
  window.addEventListener('load', () => {
    setTimeout(() => {
      try {
        ...
        console.log('DEBUG LAYOUT — page-content padding-left (computed):', window.getComputedStyle(content || document.body).paddingLeft);
      } catch (e) {
