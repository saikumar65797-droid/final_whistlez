    ...
    <div className="su-page-main-container">
      ...
      <div className={`su-page-inner-container ${isCollapsed ? 'su-collapsed' : 'su-expanded'}`}>
        ...
        <div className="su-page-content">
          <section className="su-dashboard-home">
            <header className="su-dashboard-top-header">
              <h1>Dashboard</h1>
            </header>

            <div className="su-dashboard-summary-cards">
              {summaryCards.map((card) => (
                <div key={card.label} className="su-summary-card">
                  <div className="su-summary-card-body">
                    <div>
                      <p className="su-summary-label">{card.label}</p>
                      <h2>{card.value}</h2>
                      <div className="su-summary-change">
                        <TrendIcon />
                        <span>{card.change}</span>
                      </div>
                    </div>
                    <div className="su-summary-card-icon">{card.icon}</div>
                  </div>
                </div>
              ))}
            </div>
            <div className="su-dashboard-content-row">
              <div className="su-dashboard-panel su-dashboard-panel--grow">
                <h2>Usage &amp; Growth</h2>

                <div className="su-growth-widget">
                  <div className="su-growth-widget-header">
                    <div>
                      <p>User Growth</p>
                    </div>
                    <button className="su-panel-filter">Week</button>
                  </div>

                  <div className="su-growth-chart">
                    {growthData.map((bar) => (
                      <div key={bar.label} className="su-chart-bar-item">
                        <span className="su-chart-bar-value">{bar.value}</span>
                        <span
                          className={`su-chart-bar ${bar.active ? 'su-chart-bar--active' : ''}`}
              ...
              <div className="su-dashboard-panel su-dashboard-panel--actions">
                <div className="su-panel-header su-panel-header--compact">
                  <h2>Quick Actions</h2>
                </div>
                <button
                  type="button"
                  className="su-action-button su-action-button--primary"
                ...
                <button
                  type="button"
                  className="su-action-button su-action-button--secondary"
                ...
                <button
                  type="button"
                  className="su-action-button su-action-button--ghost"
            ...
            <div className="su-dashboard-table-row">
              <div className="su-dashboard-panel su-dashboard-table-panel">
                <div className="su-panel-header">
                  <div>
                    <h2>Today User</h2>
                  </div>
                  <button className="su-view-all" onClick={() => navigate('/users')}>View All</button>
                </div>
                <table className="su-dashboard-table">
                  <thead>
                    <tr>
                      <th>S.NO</th>
                      <th>PROFILE</th>
                      ...
                      <tr key={user.sno}>
                        ...
                        <td>
                          {user.avatarType === 'photo' ? (
                            <img className="su-avatar su-avatar--photo" src={user.avatarSrc} alt={user.name} />
                          ) : (
                            <span className="su-avatar su-avatar--initial">{user.initial}</span>
                          )}
                        </td>
                        <td>{user.name}</td>
                        <td>{user.email}</td>
              ...
              <div className="su-dashboard-panel su-dashboard-table-panel">
                <div className="su-panel-header">
                  ...
                  <button className="su-view-all" onClick={() => navigate('/business')}>View All</button>
                </div>
                <table className="su-dashboard-table">
                  <thead>
                    <tr>
                      ...
                      <tr key={business.sno}>
                        ...
                        <td>
                          {business.avatarType === 'photo' ? (
                            <img className="su-avatar su-avatar--photo" src={business.avatarSrc} alt={business.name} />
                          ) : (
                            <span className="su-avatar su-avatar--initial">{business.initial}</span>
                          )}
                        </td>
                        <td>{business.name}</td>
                        ...
                        <td>
                          <button
                            type="button"
                            className="su-table-action-link"
