            ...
            <div className="live-queue-header">
              ...
              <div className="live-queue-summary-strip">
                <div className="summary-item--waiting">
                  <div className="orange"><WaitingPeopleIcon /></div>
                ...
                <div className="summary-item">
                  <div className="violet"><NextUpPersonIcon /></div>
                  <div className="summary-item-values">
                    <p>Next Up</p>
                    <strong>2</strong>
                    <span>Person</span>
                ...
                <div className="summary-item">
                  <div className="blue"><ServingPersonIcon /></div>
                  <div className="summary-item-values">
                    <p>Serving</p>
                    <strong>1</strong>
                    <span>Person</span>
                ...
                <div className="summary-item">
                  <div className="green"><CompletedPeopleIcon /></div>
                  <div className="summary-item-values">
                    <p>Completed</p>
                    <strong>1138</strong>
                    <span>People</span>
            ...
            <div className="admin-queue-board">
              <div className="waiting-column">
                <div className="orange">
                  <div className="queue-column-title">
                    <span className="orange"><WaitingPeopleIcon /></span>
                    Waiting
                  </div>
                  <span>(86)</span>
                </div>
              ...
              <div className="violet-column">
                <div className="violet">
                  <div className="queue-column-title">
                    <span className="violet"><NextUpPersonIcon /></span>
                    Next Up
                  </div>
                  <span>(2)</span>
                </div>
                <div className="next-card">
                  ...
                  <div className="card-actions">
                    <button type="button" className="outline">Hold</button>
                    <button type="button" className="blue">Notify</button>
                  </div>
              ...
              <div className="blue-column">
                <div className="blue">
                  <div className="queue-column-title">
                    <span className="blue"><ServingPersonIcon /></span>
                    Serving
                  </div>
                  <span>(1)</span>
                </div>
              ...
              <div className="green-column">
                <div className="green">
                  <div className="queue-column-title">
                    <span className="green"><CompletedPeopleIcon /></span>
                    Completed
                  </div>
                </div>
